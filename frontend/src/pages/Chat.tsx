        ...
        {messages.map((msg) => (
          ...
          >
            <div className="max-w-[80%]">
              ...
              >
                {msg.role === 'assistant' ? (
                  <div className="prose prose-invert prose-sm max-w-none prose-headings:text-white prose-strong:text-white prose-p:text-white/80 prose-li:text-white/80 prose-code:bg-[#1A1A1A] prose-code:text-[#C8A84E] prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-pre:bg-[#0A0A0A] prose-pre:border prose-pre:border-[#1A1A1A] prose-table:border-collapse prose-th:border prose-th:border-[#1A1A1A] prose-th:px-3 prose-th:py-2 prose-th:bg-[#1A1A1A] prose-th:text-white prose-td:border prose-td:border-[#1A1A1A] prose-td:px-3 prose-td:py-2 prose-td:text-white/70">
          ...
          <div className="flex justify-start">
            <div className="bg-[#0A0A0A] border-l-2 border-[#C8A84E] rounded-lg px-4 py-4">
              <div className="flex items-center gap-1.5">
                <div
                  className="w-2 h-2 rounded-full bg-[#C8A84E] animate-bounce"
